...
namespace Mods
{
    public class ClockMode
    {
        ...
        private void SetTime()
        {
            ...
            if (dateTime.Hour > 12)
            {
                bitHour = (byte)(118 - (dateTime.Hour - 12) * 5 * 2);
            }
            else
            {
                bitHour = (byte)(118 - dateTime.Hour * 5 * 2);
            }
            byte bitMinute = (byte)(118 - dateTime.Minute * 2);
            byte bitSecond = (byte)(118 - dateTime.Second * 2);
